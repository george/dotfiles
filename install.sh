...
bot "Consider installing this other software:"
bot "- StatusClock : 2nd clock in menu bar : https://itunes.apple.com/us/app/status-clock/id552792489?mt=12"
bot "- Divvy : window managment : http://mizage.com/divvy"
